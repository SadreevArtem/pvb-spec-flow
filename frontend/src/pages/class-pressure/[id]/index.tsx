...
import { ClassPressureDetail } from "@/components/ClassPressureDetail/ClassPressureDetail";
...
export default function ClassPressures() {
  ...
  return (
    <div className="items-center justify-items-center min-h-screen">
      <main className="w-full">
        {isAuth && <ClassPressureDetail id={numericId} />}
      </main>
      <footer></footer>
    </div>
  );
